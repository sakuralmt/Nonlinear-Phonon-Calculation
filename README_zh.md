...
[WS₂ 声子谱文献对照](docs/WS2_LITERATURE_PHONONS.md)（[PDF](output/pdf/ws2_literature_phonons_20260925.pdf)）将 QE 与自行弛豫的 TECE、Prophet、EquiformerV3 Stage1 的 6×6 结果同公开单层 LDA/PBE Γ 点谐波频率、室温 Raman、M/K 二阶峰及文献声学—光学间隙比较，并明确直接与间接证据的区别。
