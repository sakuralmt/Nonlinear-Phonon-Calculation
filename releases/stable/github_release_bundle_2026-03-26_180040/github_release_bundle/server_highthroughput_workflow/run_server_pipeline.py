...
# ============================
WORK_DIR = Path.cwd()
MODE_PAIRS_JSON = WORK_DIR / "hex_qgamma_qpair_workflow" / "hex_qgamma_qpair_run" / "mode_pairs" / "selected_mode_pairs.json"
STRUCTURE = WORK_DIR / "nonlocal phonon" / "scf.inp"
PSEUDO_DIR = WORK_DIR / "nonlocal phonon"
...
def benchmark_script():
    return ROOT / "mlff_modepair_workflow" / "benchmark_golden_pair.py"
    ...
    lines = [
        ...
        " ".join(
            [
                HT_PYTHON_BIN,
                shlex.quote("-u"),
                shlex.quote(str(SCRIPT_DIR / "continue_after_screening.py")),
